...
const fleetData = [
  ...
  { category: 'Sedan', name: 'Maruti Suzuki Dzire', image: '/src/assets/dzire.png', idealFor: 'Airport & Business Travel' },
  ...
  { category: 'MUV', name: 'Maruti Suzuki Ertiga', image: '/src/assets/ertiga.png', idealFor: 'Family & Group Travel' },
  { category: 'Premium MUV', name: 'Toyota Innova Crysta', image: '/src/assets/innova.png', idealFor: 'Corporate & Long Trips' },
  ...
  { category: 'Executive Luxury', name: 'Mercedes-Benz S-Class', image: '/src/assets/hero_airport.png', idealFor: 'Elite VVIP Transportation' },
