...
const fleetData = [
  ...
  { category: 'Sedan', name: 'Dzire / Amaze / Aura', image: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&q=80&w=800', idealFor: 'Airport & Business' },
  ...
  { category: 'Mid-Size SUV', name: 'Creta / Seltos / Hyryder', image: 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&q=80&w=800', idealFor: 'Comfortable Journeys' },
  { category: 'Premium SUV', name: 'XUV700 / Safari / Hector', image: 'https://images.unsplash.com/photo-1503370973809-b4b9b7754b2d?auto=format&fit=crop&q=80&w=800', idealFor: 'Family Outstation' },
  { category: 'MUV', name: 'Maruti Ertiga / Kia Carens', image: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80&w=800', idealFor: 'Family & Group Travel' },
  { category: 'Premium MUV', name: 'Innova Crysta / HyCross', image: 'https://images.unsplash.com/photo-1563720223185-11003d516935?auto=format&fit=crop&q=80&w=800', idealFor: 'Corporate & Long Trips' },
  { category: 'Luxury SUV', name: 'Toyota Fortuner / BMW X5', image: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?auto=format&fit=crop&q=80&w=800', idealFor: 'VIP Outstation' },
  { category: 'Luxury Sedan', name: 'Mercedes E-Class / BMW 5', image: 'https://images.unsplash.com/photo-1616423640778-28d1b53229bd?auto=format&fit=crop&q=80&w=800', idealFor: 'Executive & VIP' },
  { category: 'Executive Luxury', name: 'Mercedes S-Class / BMW 7', image: '/src/assets/hero_airport.png', idealFor: 'Elite VVIP Transportation' },
  ...
  { category: 'Force Urbania', name: '10 / 13 / 17 Seater Urbania', image: '/src/assets/urbania.png', idealFor: 'Luxury Group Chauffeur' },
